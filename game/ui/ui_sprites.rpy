...
init 2 python:
    ...
    # Saki sprites
    saki_original_width = 2560
    saki_original_height = 3840
    saki_scale = 0.25
    saki_close_scale = 0.35
    ...
    # Normal Saki sprites
    make_sprites('saki', saki_expr_list, suffix_list=['cas', 'swim'], scale=saki_scale)
    # Close Saki sprites
    make_sprites('saki', saki_expr_list, suffix_list=['cas', 'swim'], scale=saki_close_scale, close=True,
                x=0, y=0, cropped_width=int(saki_original_width*saki_close_scale), cropped_height=1050)

    # Chisato sprites
    chisato_original_width = 2560
    chisato_original_height = 3973
    chisato_scale= 0.25
